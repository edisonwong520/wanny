...
const brandIconUrl = "https://cdn.msbros.net/online/wanny/homepage/wanny-icon.svg";
  ...
  <header class="sticky top-0 z-40 bg-white border-b border-[#EDEDED]">
    <div class="relative mx-auto max-w-6xl px-4 py-3">
      <div class="flex items-center justify-between gap-4">
        <RouterLink class="flex shrink-0 items-center gap-2" to="/landing">
          <img
            alt="Wanny logo"
      ...
      <nav class="pointer-events-none absolute inset-x-0 top-1/2 hidden -translate-y-1/2 justify-center md:flex">
        <div class="pointer-events-auto flex items-center gap-1 rounded-full bg-white/90 px-1 py-1 backdrop-blur-sm">
          <RouterLink
            to="/landing"
