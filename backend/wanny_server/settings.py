"""
Django settings for wanny_server project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-dev-only-key-please-change-in-production')
...
WSGI_APPLICATION = 'wanny_server.wsgi.application'
ASGI_APPLICATION = 'wanny_server.asgi.application'
