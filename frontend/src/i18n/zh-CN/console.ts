export default {
  ...
  care: {
    ...
    title: "主动巡检与人文关怀",
    description: "把保养提醒、设备状态和可执行建议聚合到一个工作台里。你可以先审阅，再决定要不要转成真正的设备操作。",
    filters: {
      all: "全部",
      allPriorities: "全部优先级",
      allTypes: "全部类型",
    ...
    labels: {
      ...
      value: "目标值",
      noDevice: "未关联设备",
      aggregated: "已合并 {count} 条同类提醒",
      filteredCount: "当前显示 {count} 条建议",
      aggregationTitle: "聚合解释",
      aggregationSummary: "这条建议由最近命中的 {count} 次同类事件合并而来。",
    },
    actions: {
      manageRules: "管理规则",
      scanNow: "立即巡检",
    ...
    feedback: {
      approved: "建议已采纳，并已生成待执行任务。",
      rejected: "建议已拒绝。",
      ignored: "建议已忽略。",
      executed: "建议执行完成。",
      scanCreated: "本次扫描新增了 {count} 条建议。",
      ruleCreated: "规则已创建。",
      ruleUpdated: "规则已更新。",
      ruleDeleted: "规则已删除。",
      weatherRefreshed: "天气数据已刷新。",
      weatherTriggered: "天气已刷新，并生成了新的关怀建议。",
      weatherSourceCreated: "天气数据源已创建。",
      weatherSourceUpdated: "天气数据源已更新。",
      weatherSourceDeleted: "天气数据源已删除。",
    },
    errors: {
      load: "读取关怀建议失败，请稍后重试。",
      action: "处理关怀建议失败，请稍后重试。",
      loadRules: "读取规则失败，请稍后重试。",
      loadWeather: "读取天气数据失败，请稍后重试。",
    },
    empty: "当前没有符合条件的关怀建议。",
    suggestions: {
      title: "当前建议",
    ...
    weather: {
      ...
      snapshot: "当前快照",
      delta: "温度变化",
      empty: "当前天气源还没有拿到有效数据。",
      noSource: "还没有配置天气数据源。",
      refresh: "刷新天气",
      sourceTitle: "天气数据源",
      sourceDescription: "先接入天气数据，再让系统生成降温提醒和空调联动建议。",
      sourceSnapshot: "最近天气",
      dataSource: "数据源",
      addSource: "添加数据源",
      ...
      feedback: {
        locationFilled: "已填入当前位置坐标。",
        locationFailed: "获取当前位置失败，请手动填写经纬度。",
        geolocationUnsupported: "当前浏览器不支持地理定位，请手动填写经纬度。",
      },
      form: {
        name: "数据源名称",
        location: "Location ID（可选，优先于经纬度）",
        latitude: "纬度",
        longitude: "经度",
        timezone: "时区",
        fetchFrequency: "拉取频率，如 30m",
        haEntityId: "HA 实体 ID，如 weather.home",
        locationHint: "优先尝试浏览器定位；若失败，可手动填写经纬度或和风 Location ID。",
      },
    },
    push: {
      title: "推送审计",
      overviewTitle: "推送策略总览",
      overviewDescription: "查看当前建议池里各推送等级和节流状态的分布。",
      total: "共 {count} 条",
      level: "推送等级",
      count: "已推送次数",
      lastPushedAt: "最近推送时间",
      repeatEligibleAt: "再次可推送时间",
      ignoredUntil: "忽略冷却截止",
      consoleOnly: "仅控制台展示",
      levels: {
        high: "高优先级推送",
      ...
      reasons: {
        console_only: "当前不会主动推送到微信",
        ignored_cooldown: "忽略后 48 小时冷却中",
        repeat_gap: "24 小时重复推送冷却中",
      },
    },
    dialog: {
      confirmEyebrow: "执行确认",
      rejectEyebrow: "拒绝原因",
      rejectTitle: "为什么暂不采纳？",
      rejectPlaceholder: "可选，记录本次拒绝的原因，便于后续减少无效提醒。",
    },
    rules: {
      eyebrow: "Rules Studio",
      title: "巡检规则",
      description: "系统预置规则负责基础兜底，自定义规则用来写入你自己的设备照护标准。",
      createTitle: "新增自定义规则",
      editTitle: "编辑自定义规则",
      systemTitle: "系统规则",
      customTitle: "自定义规则",
      ...
      form: {
        name: "规则名称",
        description: "规则说明",
        deviceCategory: "设备分类，如 water_purifier",
        threshold: "阈值",
        priority: "优先级",
        cooldownHours: "冷却小时数",
        template: "建议模板，如 {device_name} 需要关注",
      },
      builder: {
        title: "条件构建器",
        control: "控制项",
        ...
        recommendation: "推荐规则",
        applyDefaults: "应用推荐值",
        recommendedOperator: "推荐操作符",
        recommendedThreshold: "推荐阈值",
        recommendedCategory: "推荐分类",
        descriptions: {
          filterLife: "适合净水器、空气净化器等耗材寿命告警。",
          waterLevel: "适合宠物饮水机、加湿器等需要补水的设备。",
          targetTemperature: "适合空调、暖通设备的温控联动提醒。",
          currentTemperature: "适合监控当前温度过高或过低的场景。",
          batteryLevel: "适合低电量传感器、扫地机等设备的续航提醒。",
          vehicleLock: "适合车辆离车后车锁安全提醒。",
          deviceStatus: "适合在线状态巡检和异常状态提醒。",
          telemetry: "适合匹配遥测摘要中的异常关键词。",
          roomName: "适合按房间名做重点区域巡检。",
          offlineHours: "适合长期离线设备的巡检提醒。",
        },
      },
      operators: {
        lt: "小于",
